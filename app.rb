...
get '/m/list' do 
  [
    {:name => 'funnymama',  :t => 'Funny Mama', :u => 'http://funnymama.com', :l => 'en', :i => 'https://www.dropbox.com/s/dm8rv2jac00lrdz/funnymama.png?dl=1', :in => 'funnymama.png'}, 
    {:name => 'ninegag', :t => '9gag',  :u => '9gag.com', :l => 'en', :i => 'https://www.dropbox.com/s/dyj4v3f6rnosyux/9gag.png?dl=1', :in => '9gag.png'}, 
